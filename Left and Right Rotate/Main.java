...
class Main 
{
  public static void left_rotate_even_elem(int n, int arr[], int no_of_rotation)
    {
    ...
    public static void right_rotate_odd_elem(int n, int arr[], int no_of_rotation)
    {
    ...
    public static void main(String args[])
    {
        ...
        left_rotate_even_elem(n, arr, no_of_rotation);
        right_rotate_odd_elem(n, arr, no_of_rotation);
